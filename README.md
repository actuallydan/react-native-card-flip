I forked this from [lhandel's react-native-card-flip](https://github.com/lhandel/react-native-card-flip) because no one merged in the one PR it needs to be useable.
